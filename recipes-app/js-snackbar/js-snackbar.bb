...
do_install () {
	...
	install -m 0755 ${WORKDIR}/git/css/js-snackbar.min.css	${D}${base_prefix}${localstatedir}/www/localhost/html/css/js-snackbar.min.css
	install -m 0755 ${WORKDIR}/git/js/js-snackbar.min.js	${D}${base_prefix}${localstatedir}/www/localhost/html/js/js-snackbar.min.js
}

FILES_${PN} += "${base_prefix}${localstatedir}/www/localhost/html/css/js-snackbar.min.css ${base_prefix}${localstatedir}/www/localhost/html/js/js-snackbar.min.js"
